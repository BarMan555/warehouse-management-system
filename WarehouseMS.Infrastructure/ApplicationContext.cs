...
namespace WarehouseMS.Infrastructure;

/// <summary>
/// Represents the database context for the AsyncWarehouse.Api application, managing entities like Pallets and InventoryItems.
/// </summary>
