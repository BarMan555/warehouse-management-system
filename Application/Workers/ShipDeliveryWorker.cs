...
namespace AsyncWarehouse.Application.Workers;

/// <summary>
/// A background worker that processes ship delivery tasks from RabbitMQ.
/// </summary>
public class ShipDeliveryWorker : BackgroundService
{
    private readonly ILogger<ShipDeliveryWorker> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ShipDeliveryWorker"/> class.
    /// </summary>
    /// <param name="logger">The logger instance.</param>
    /// <param name="scopeFactory">The factory for creating service scopes.</param>
    public ShipDeliveryWorker(ILogger<ShipDeliveryWorker> logger, IServiceScopeFactory scopeFactory)
    {
        _logger = logger;
    ...
    /// <summary>
    /// Executes the background task of listening for and processing ship delivery messages.
    /// </summary>
    ...
    protected async override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        await _channel.QueueDeclareAsync(queue: "ship_queue", durable: true, exclusive: false, autoDelete: false,
            cancellationToken: stoppingToken);
        await _channel.QueueBindAsync(queue: "ship_queue", exchange: "delivery_exchange", routingKey: "ship",
            cancellationToken: stoppingToken);
        ...
        consumer.ReceivedAsync += async (model, ea) =>
        {
            ...
            _logger.LogInformation($"[Корабль] Асинхронно получена задача на палетку: {dispatchData?.PalletId}");
            ...
            _logger.LogInformation($"[Корабль] Палетка {dispatchData?.PalletId} обработана.");
        ...
        await _channel.BasicConsumeAsync(queue: "ship_queue", autoAck: false, consumer: consumer,
            cancellationToken: stoppingToken);
